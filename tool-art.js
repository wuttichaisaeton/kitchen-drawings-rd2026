...
(function () {
  ...
  var PROFILES = {
    ...
    // #453 Gooseneck — TRACED 1:1 from เอ๋'s clean QCAD DXF/SVG (453.dxf, 2026-06-07).
    // Solid outline only (W54 × H120). Throat = real ARC R20 (center ≈(-1.62,46.17)),
    // tessellated to 6 pts. Tip at origin, Y up. (The DXF also carried a clearance
    // envelope tip→(-42.43,42.43)→(-5,79.85) = 60mm@45° — not part of this silhouette.)
    '453': [[0,0],[4.24,4.24],[3.54,4.95],[49,50.41],[49,78.5],[37,90.5],[21,90.5],[21,94.5],[17.5,94.5],[17.5,103],[21,103],[21,120],[8,120],[8,90.5],[-5,90.5],[-5,79.85],[13.26,59.53],[15.7,56.17],[17.7,51.34],[18.38,46.17],[17.7,41],[15.34,35.57],[-4.24,4.24]],
