...
(function () {
  ...
  var PROFILES = {
    ...
    // #453 / #463 Gooseneck (Thin-Tip Small Gooseneck) — TRACED from the KYOKKO catalog
    // graph (เอ๋ 2026-06-07, "เขียนเวกเตอร์ตามกราฟ"): #453 D=88°, #463 D=90°, W56 × H120,
    // throat R10, relief ~25mm tall, vertical clearance ~50mm (catalog diamond grid).
    // Tip at origin, Y up. (Replaces the earlier DXF trace whose throat was R15.)
    '453': [[0,0],[3,3],[49,52],[49,78],[35,91],[20,91],[20,95],[17,95],[17,103],[20,103],[17,120],[7,120],[7,91],[-7,91],[-7,80],[11,61],[15,54],[16,48],[15,42],[11,36],[-4,4]],
    '463': [[0,0],[3,3],[49,52],[49,78],[35,91],[20,91],[20,95],[17,95],[17,103],[20,103],[17,120],[7,120],[7,91],[-7,91],[-7,80],[11,61],[15,54],[16,48],[15,42],[11,36],[-4,4]],
    // #103 30° Acute Punch — RE-TRACED from clean 103.dxf "Visible" layer (เอ๋ 2026-06-05).
    // The DXF was 2× scale; real punch W27 × H97 (was wrongly H194). Tip at origin, Y up.
